...
@section('content')
    ...
    <div class="py-10 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="relative">
                        <input
                            ...
                            class="pl-10 pr-4 py-2 w-full sm:w-64 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 outline-none text-sm"
                        >
            ...
            <div class="overflow-x-auto mt-4 bg-white rounded-xl shadow-sm border border-slate-200">
